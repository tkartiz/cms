<div class="d-flex w-100" style="background-color:lightgray">
    <div class="tag order-2" style="width:150px;">
        ...
        ?>
        <div id="<?php echo $contentID . 'tray1'; ?>" class="tray1 d-none" style="top:46px; left:-210px;">
        ...
        <div id="<?php echo $contentID . 'tray2'; ?>" class="tray2 d-none" style="top:46px; left:-180px;">
            <?php for ($k = 0; $k < count($color_array); $k++) { ?>
    ...
    <textarea id=<?php echo $contentID ?> class="order-1" style="width:90%; height:<?php echo $heights ?>" name=<?php echo $contentID ?>><?php echo $contents ?></textarea>
</div>
