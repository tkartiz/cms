...
<body>
    ...
    <div class="container">
        ...
        <div class="position-relative">
            ...
            <img class="position-absolute bottom-0 start-0" style="width:170px; height:auto; transform:translateY(50%);" src="<?php echo $layer; ?>asset/img/news/surfer.svg" alt="サーファーイラスト">
        </div>
    </div>
