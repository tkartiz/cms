        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="w-full ms-auto flex px-5 mt-4">
                    ...
                    <button onclick="" class="w-24 flex me-auto btn px-2 py-1 text-center text-sm text-white bg-red-500 border-0 focus:outline-none hover:bg-red-600 rounded-lg">
