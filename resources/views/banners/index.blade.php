                                        ...
                                        <tr class="<?php echo $banner->release; ?>">
                                            ...
                                            <td class="border border-slate-300">
                                                <form id="del_{{ $banner->id }}" method="post" action="{{ route('banners.destroy', $banner->id) }}">
                                                    @csrf
                                                    @method('delete')
                                                    <a href="#" data-id="{{ $banner->id }}" onclick="delAnnounce(this)" class="w-full p-1 text-center">
                                            ...
                                            <td class="text-sm border border-slate-300">{{ $banner->filename }}</td>
                                            <td class="text-start text-sm border border-slate-300">{{ $banner->filepath }}</td>
