        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="w-full ms-auto flex px-5 mt-4">
                    ...
                    <form method="POST" action="{{ route('banners.store') }}" enctype="multipart/form-data" class="ms-auto flex bg-gray-200 rounded-r-xl">
                        @csrf
                        ...
                        <div class="flex text-sm items-center">
                            <ul class="w-20 me-3 font-medium text-gray-700">
                                <li class="w-full">
                            ...
                            <div>
                                <div class="flex">
                                    <label for="pc" class="w-24 py-1 ms-2 text-gray-700">PC(300x250)</label>
                                    <input id="pc" class="w-56 p-0 m-0" type="file" name="file[]" required>
                                </div>
                                <div class="flex">
                                    <label for="sp" class="w-24 py-1 ms-2 text-gray-700">スマホ(320x50)</label>
                                    <input id="sp" class="w-56 p-0 m-0" type="file" name="file[]" required>
                                </div>
                            </div>
                        </div>
                    </form>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th rowspan="2" class="w-12 px-2 py-1 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 border border-slate-300">
                                                削除</th>
                                            <th colspan="2" class="px-2 py-1 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 border border-slate-300">
                                                PC用バナー</th>
                                            <th colspan="2" class="px-2 py-1 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 border border-slate-300">
                                                スマホ用バナー</th>
                                            <th rowspan="2" class="w-24 py-2 pb-1 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 border border-slate-300">
                                                作成日</th>
                                        </tr>
                                        <tr>
                                            <th class="w-1/4 px-2 py-1 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 border border-slate-300">
                                                ファイル名</th>
                                            <th class="w-3/4 px-2 py-1 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 border border-slate-300">
                                                画像</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="<?php echo $banner->release; ?>">
                                            <td class="border border-slate-300">
                                                <form id="update_{{ $banner->id }}" method="post" action="{{ route('banners.update', $banner->id) }}">
                                                    @csrf
                                                    @method('put')
                                                    <a href="#" data-id="{{ $banner->id }}" onclick="updateBanner(this)" class="w-full p-1 text-center">
                                            ...
                                            <td class="border border-slate-300">{{ $banner->id }}</td>
                                            <td class="border border-slate-300">
                                            ...
                                            <td class="text-sm border border-slate-300">{{ $banner->filename_pc }}</td>
                                            <td class="p-2 text-sm border border-slate-300">
                                                <img src="{{ asset($banner->filepath_pc) }}" alt="">
                                            </td>
                                            <td class="text-sm border border-slate-300">{{ $banner->filename_sp }}</td>
                                            <td class="p-2 text-sm border border-slate-300">
                                                <img src="{{ asset($banner->filepath_sp) }}" alt="">
                                            </td>
