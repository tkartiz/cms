                                    ...
                                    <tbody>
                                        ...
                                        <tr class="<?php echo $document->release; ?>">
                                            <td class="border border-slate-300">
                                                <form id="update_{{ $document->id }}" method="post" action="{{ route('documents.update', $document->id) }}">
                                                    @csrf
                                                    @method('put')
                                                    <input type="hidden" name="release" value="{{ $document->release }}" />
                                                    <a href="#" data-id="{{ $document->id }}" onclick="updateDocument(this)" class="w-full p-1 text-center">
                                            ...
                                            <td class="border border-slate-300">
                                                <form id="del_{{ $document->id }}" method="post" action="{{ route('documents.destroy', $document->id) }}">
                                                    @csrf
                                                    @method('delete')
                                                    <a href="#" data-id="{{ $document->id }}" onclick="delDocument(this)" class="w-full p-1 text-center">
