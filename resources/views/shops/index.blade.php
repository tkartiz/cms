                                ...
                                <table class="w-full table-fixed border-separate border border-slate-400 text-center whitespace-no-wrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="<?php echo $shop->release; ?>">
                                            ...
                                            <td rowspan="2" class="border border-slate-300">
                                                @if($shop->release === "release")
                                                <a href="{{ 'main/areamap/service/shops.php?shop='.$shop->stamp }}" target='_BLANK' class="w-full p-1 text-center">
                                                    @else
                                                    <a href="{{ 'preview/areamap/service/shops.php?shop='.$shop->stamp }}" target='_BLANK' class="w-full p-1 text-center">
                                                        @endif
