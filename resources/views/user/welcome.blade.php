...
<body class="antialiased">
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="w-full flex justify-center sm:justify-start sm:pt-0">
                <x-application-logo class="ms-auto fill-current text-gray-600" style="width:auto; height:2rem;"/>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold">道の駅ちがさき用CMS</div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                道の駅ちがさきのお知らせ記事追加・編集・削除が行えます。<br>
                                マニュアル　⇒　
                            </div>
                        </div>
                    </div>
